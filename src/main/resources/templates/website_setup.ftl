...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:th="http://www.thymeleaf.org"
   ...
   <#-- <div id="logo" class="sidebar-header">
    ...
    <ul class="nav nav-subnav">
    <li class="active"><a href="/initWebsiteSetup">网站设置</a></li>
    ...
    <span class="navbar-page-title"> 网站设置 </span>
    </div>
    ...
    <div class="form-inline " style="margin-bottom: 20px">
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;网站标题:
        &nbsp;&nbsp;&nbsp;<input class="form-control" type="text" id="web_title" name="web_title"
               value="${web.web_title}" placeholder="请输入站点标题"  size="39"  style="margin-left:30px">
    </div>
    <div class="form-inline" style="margin-bottom: 20px">
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;网站LOGO：
        <div class="input-group">
            <input type="file" class="form-control" name="web_logo" id="web_logo"   style="margin-left:22px"
                   value="/home/images/logo.png"/>
        </div>
    </div>
    <div class="form-inline" style="margin-bottom: 20px">
       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;网站域名：
        <input class="form-control" type="text" id="web_domain_name"    style="margin-left: 30px"
               size="39"    name="web_domain_name" value="${web.web_domain_name}" placeholder="请输入站点域名">
    </div>
    <div class="form-inline" style="margin-bottom: 20px">
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 公司邮箱：
        <input  size="39" class="form-control" type="text" id="web_email" name="web_email"    style="margin-left:28px"
               value="${web.web_email}" placeholder="请输入公司邮箱">
    </div>
    <div class="form-inline" style="margin-bottom: 20px">
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;站点语言：
        <select class="form-control"  name="language"  id="language"   style="margin-left:30px;width:150px">
    ...
    <div class="form-inline" style="margin-bottom: 20px">
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;站点开关：
        <label class="lyear-switch switch-solid switch-primary"   id="web_status"   style="margin-left:30px">
        <#if web.web_status==1>

                    <input type="checkbox" checked="checked" name="web_status"  style="margin-left:30px">
            </#if>
            <#if web.web_status==2>
                    <input type="checkbox"  name="web_status"   style="margin-left:30px">
             </#if>

            <span></span>

        </label>
        <small class="help-block"  style="margin-left: 100px;font-weight: 400">站点关闭后将不能访问，后台可正常登录</small>

    </div>
    <div class="form-group">
        <button type="button" class="btn btn-primary m-r-5"  id="save"  style="margin-left: 100px">保 存</button>
    </div>
    ...
    <script type="text/javascript">
        ...
        var logo=$("#logo").val();
        var domain_name=$("#web_domain_name").val();
        var web_email=$("#web_email").val();
        var web_status=$("#web_status").val();
        var webSeting={"web_status":web_status,"web_title":title,"web_domain_name":domain_name,"web_logo_path":logo,"web_email":web_email}
               $.ajax({
                   url:"/updateWebSet",
                   type:"post",
                   data:JSON.stringify(webSeting),
                   dataType:"text",
                   ...
                   success:function (data) {
                       swal(
                           ...
                           location.href="/initWebsiteSetup";
                       })
