                    ...
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item nav-item-has-subnav active open">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="active"> <a href="/initserviceHtttp">服务协议</a> </li>
            ...
            <nav class="navbar navbar-default">
                <div class="topbar"   style="height:0px">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 网站管理&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;服务协议 </span>
                    </div>
                                ...
                                <div class="table-responsive">
                                   <#-- <form action="#!" method="post" name="edit-form" class="edit-form">-->
                                        ...
                                        <div class="form-group">
                                            <div class="bg-lightest p-10"  id="div1">
                                         <p> ${serviceContent}</p>
                                            </div>
                                            <button type="submit" class="btn btn-primary m-r-5"  id="save">保 存</button>
                                        </div>
                               <#--     </form>-->
...
<script type="text/javascript">
    ...
    document.getElementById('save').addEventListener('click', function () {
        ...
        $.ajax({
            url:"/updataServiceHttpContent",
            type:"post",
            data:{"service_agreement_content":content},
